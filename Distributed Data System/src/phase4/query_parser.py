...
def moveTable(reln_name, site_id, result_site):
    # IP Addresses
    URLS = {}
    URLS['1'] = 'http://10.3.5.215:8081/move_table'
    URLS['2'] = 'http://10.3.5.214:8081/move_table'
    URLS['3'] = 'http://10.3.5.213:8081/move_table'
    URL = URLS[str(site_id)]
...
def moveSemiJoinTable(R, S, site1, site2, join_attr):
    ...
    # IP Addresses
    URLS = {}
    URLS['1'] = 'http://10.3.5.215:8081/move_sj_table'
    URLS['2'] = 'http://10.3.5.214:8081/move_sj_table'
    URLS['3'] = 'http://10.3.5.213:8081/move_sj_table'
...
class Query(object):
    ...
    def __init__(self, query):
        ...
        self.frag_parents = {}
        self.join_col_pairs = set(('vendorID', 'vendorID'))
...
def executeUpdateQuery(query):
    ...
    def createTempTable(table_name, attributes, where_clause):
        ...
        QUERY = " INSERT INTO tmpupd_table VALUES {};".format(data)
        print(QUERY)
        executeQuery(QUERY,'1')
